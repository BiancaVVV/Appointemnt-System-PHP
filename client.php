		...
		<div class="panel-heading">
			<div class="row">
				...
				<div class="col-md-2" align="right">
					<button type="button" id="addclient" class="btn btn-success" title="Add client"><span class="glyphicon glyphicon-plus">Add</span></button>
				</div>
				<?php } ?>
			</div>
		</div>
    		...
    		<form method="post" id="clientForm">
    			<div class="modal-content">
    				...
    				<div class="modal-body">
						...
						<div class="form-group">
							<label for="description" class="control-label">More Details</label>
    	...
    	<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="p_history" class="control-label">More Details:</label>
