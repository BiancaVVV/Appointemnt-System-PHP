...
if(!$user->loggedIn() || ($user->loggedIn() && $_SESSION["role"] == 'client')) {
...
<body>
		...
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="row">
				...
				<div class="col-md-2" align="right">
					<button type="button" id="addconsultant" class="btn btn-success" title="Add consultant"><span class="glyphicon glyphicon-plus">Add</span></button>
				</div>
			</div>
		</div>
		<table id="consultantListing" class="table table-bordered table-striped">
			<thead>
				<tr>
					<th>#</th>
					<th>Name</th>
	...
	<div id="consultantModal" class="modal fade">
	...
	<div id="consultantDetails" class="modal fade">
    	<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title"><i class="fa fa-plus"></i> consultant Details</h4>
				</div>
				<div class="modal-body">
					<div class="form-group">
						<label for="name" class="control-label">Name:</label>
