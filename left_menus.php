...
<?php if($user->isAdmin()) { ?>
	...
	<li class="nav-item"><a class="nav-link" href="consultant.php"><strong>Consultants</strong></a></li>
	<li class="nav-item"><a class="nav-link" href="client.php"><strong>Clients</strong></a></li>
